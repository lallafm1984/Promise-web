...
function AlreadyRespondedCard({ card }: { card: PublicCardView }) {
  return (
    <section className="app-card-shadow w-full min-w-0 rounded-[20px] border-2 border-[var(--app-line)] bg-[var(--app-surface)] p-5">
      ...
      <div className="mt-4 min-w-0 rounded-[16px] border-2 border-[var(--app-line)] bg-[var(--app-paper)] p-3">
      ...
      <a
        ...
        className="mt-5 flex min-h-12 w-full min-w-0 items-center justify-center rounded-[14px] border-2 border-[var(--app-line)] bg-[var(--app-primary)] px-4 text-sm font-black text-white">
        나도 카드 만들기
      </a>
    </section>
  );
